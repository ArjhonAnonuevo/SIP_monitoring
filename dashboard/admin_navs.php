...
<body class="bg-gray-100">
    <nav class="flex items-center bg-green-800 p-2 flex-wrap">
        <button id="sidebar-toggle" class="lg:hidden p-2 mr-2 text-white hover:bg-gray-100 hover:text-gray-800 focus:bg-gray-100 focus:text-gray-800 rounded-full">
            <span class="sr-only">Menu</span>
            <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h7"/>
            </svg>
        </button>
        <div id="sidebar" class="sidebar bg-green-800 lg:open">
            <ul class="flex flex-col py-4 space-y-1">
                ...
                <a href="../admin_dashboard.php" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Application</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="../attendance/qr generate.php"
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Interns QR</span>
                    </a>
                </li>
                <li>
                    <a href="../certifications/certifications.php"
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Interns Request</span>
                    </a>
                </li>
                <li class="px-5">
                    <div class="flex flex-row items-center h-8">
                ...
                <li>
                    <a href="#" class="relative flex flex-row items-center focus:outline-none text-white border-l-4 border-transparent pr-6"
        ...
        <div class="relative ml-auto">
            <button
                class="flex items-center text-white px-4 py-2 rounded focus:outline-none">
    ...
    <script>
       $(document).ready(function () {
            $(".lg\\:hidden").each(function (_, navToggler) {
