    ...
    <div class="col-md-4 mx-auto">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="attendance.php" class="btn btn-success">View</a>
        </div>
      </div>
    </div>
    <div class="col-md-4 mx-auto">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="../monthly reports/reports.php" class="btn btn-success">View</a>
        </div>
      </div>
    </div>
    <div class="col-md-4 mx-auto">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="../tailwind_configs/src/index.php" class="btn btn-success">View</a>
        </div>
      </div>
    </div>
  </div>
