...
<div class="flex flex-wrap min-h-screen w-full content-center justify-center bg-gray-200 py-10">
  ...
  <div class="w-full sm:w-auto sm:max-w-xs md:max-w-sm lg:max-w-md xl:max-w-lg">
        ...
        <form action="login_process.php" method="post" class="mt-4">
          ...
          <div class="mb-3">
            <button class="mb-1.5 block w-full text-center text-white bg-green-800 hover:bg-green-700   -px-2 py-1.5 rounded-md">Login</button>
          </div>
        </form>
        ...
        <div class="text-center">
          ...
          <a href="internsregister.php" class="text-xs font-semibold text-green-700">Sign up</a>
        </div>
      </div>
    </div>
