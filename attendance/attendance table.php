  ...
  <section class="py-1 bg-blueGray-50">
    <div class="w-full xl:w-100 mb-12 xl:mb-0 px-4 mx-auto mt-0">
      <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
        <div class="rounded-t mb-0 px-4 py-3 border-0">
          <div class="flex flex-wrap items-center">
            <div class="relative w-full px-4 max-w-full flex-grow flex-1">
              <h3 class="font-semibold  text-blueGray-700 text-xl" style="font-family: 'Montserrat', sans-serif;">Attendance Record</h3>
            </div>
        ...
        <div class=" w-full overflow-x-auto flex flex-wrap items-center">
  <table id="attendanceTable" class="items-center bg-transparent w-full border-collapse">
    <thead>
